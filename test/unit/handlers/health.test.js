...
Test('test Health get operation', async function (t) {
  ...
  const options = {
    ...
    headers: { 'fspiop-source': 'source', date: 'date', 'Content-Type': 'application/json', accept: 'application/json' }
  }
  if (mock.request.body) {
    ...
    options.headers = { 'fspiop-source': 'source', date: 'date', 'Content-Type': 'application/json', accept: 'application/json' }
  }
